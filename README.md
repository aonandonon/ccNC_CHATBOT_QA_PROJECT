...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>RAG 체인 파이프라인 구성</td>
    </tr>
    <tr>
      <td><b>Embedding</b></td>
      <td><code>text-embedding-3-small</code></td>
      <td>매뉴얼 문맥의 고성능 벡터화</td>
    </tr>
    <tr>
      <td><b>Vector DB</b></td>
      <td><code>DocArrayInMemorySearch</code></td>
      <td>메모리 기반 초고속 유사도 검색 (k=5)</td>
    </tr>
    <tr>
      <td><b>LLM</b></td>
      <td>OpenAI <code>gpt-4o-mini</code> (temp=0.2)</td>
      <td>검색된 문맥 기반 답변 생성</td>
    </tr>
  </tbody>
</table>
